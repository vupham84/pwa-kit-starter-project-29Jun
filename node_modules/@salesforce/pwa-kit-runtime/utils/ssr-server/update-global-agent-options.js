...
exports.updateGlobalAgentOptions = exports.AGENT_OPTIONS_TO_COPY = void 0;
/*
 ...
 */
const AGENT_OPTIONS_TO_COPY = exports.AGENT_OPTIONS_TO_COPY = ['ca', 'cert', 'ciphers', 'clientCertEngine', 'crl', 'dhparam', 'ecdhCurve', 'honorCipherOrder', 'key', 'passphrase', 'pfx', 'rejectUnauthorized', 'secureOptions', 'secureProtocol', 'servername', 'sessionIdContext'];
 ...
 */
const updateGlobalAgentOptions = (from, to) => {
...
exports.updateGlobalAgentOptions = updateGlobalAgentOptions;